        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900">
            <form onSubmit={onSubmit} className="bg-white dark:bg-gray-800 p-8 shadow-lg rounded-lg w-full max-w-md">
                ...
                <button
                    ...
                    className="w-full py-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 focus:outline-none disabled:bg-blue-400 transition duration-200"
                >
                    Sign in
                </button>
                <p className="text-sm mt-4 text-center text-gray-600 dark:text-gray-400">
                    Don't have an account?{' '}
                    <Link to="/register" className="text-blue-500 hover:text-blue-600 hover:underline">Register</Link>
                </p>
            </form>
        </div>
    )
